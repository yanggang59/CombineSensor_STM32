...
static void CAN_Mode_Config(void)
{
  ...
  RCC_APB1PeriphClockCmd(CAN_CLK, ENABLE);
	...
	CAN_InitStructure.CAN_BS1=CAN_BS1_8tq;		   //BTR-TS1 时间段1 占用了5个时间单元
	...
	CAN_InitStructure.CAN_Prescaler =9;		   ////BTR-BRP 波特率分频器  定义了时间单元的时间长度 36/(1+5+3)/4=1 Mbps
...
{	  
  ...
  {
    TxMessage->Data[ubCounter] = ubCounter+5;
  }
}
/**************************END OF FILE************************************/
